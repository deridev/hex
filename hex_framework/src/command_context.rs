...
use self::{context_helper::CommandContextHelper, option_handler::OptionHandler};
...
impl CommandContext {
    ...
    pub fn guild_id(&self) -> anyhow::Result<Id<GuildMarker>> {
        self.interaction.guild_id.context("Expected a Guild")
    }
    ...
    pub fn db(&self) -> Arc<HexDatabase> {
        self.database.clone()
    }
